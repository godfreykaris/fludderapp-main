...
export default function UserGuideOne({ navigation }) {
  ...
  const pressHandler1 = () => {
    navigation.navigate('UserGuideTwo');
  }
  return (
    <View style={{ flex: 1, }}>
      <View style={styles.container}>
        ...
        {/* <Image source={Image_Http_URL} style = {{height: 60, width:150, resizeMode: 'stretch', margin: 5 }} /> */}
        ...
        <Text style={styles.onboarding}>Step 1: Explore and Practice</Text>
        <Text style={styles.onboardingText}>
          Explore interview questions, practice recording your answers, and submit your videos for review.
        </Text>
