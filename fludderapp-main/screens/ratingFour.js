...
export default function RatingFour({ navigation }) {
    ...
    const thirdRating = navigation.getParam('currentRating');

    const pressHandler = (fourthRating) => {
        setCurrentRating(fourthRating);
    }
    const pressHandler1 = () => {
        navigation.navigate('RatingThree', { answer, reviewText, firstRating, secondRating });
    }
    const pressHandler2 = () => {
        if (currentRating > 0)
            navigation.navigate('RatingFive', { answer, reviewText, firstRating, secondRating, thirdRating, currentRating });
        else
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ backgroundColor: '#fff' }}>
                <View style={styles.container}>
                    ...
                    <View style={styles.ProfessionalismQuestionBox}>
                        <Text style={{ fontSize: 22 }}>Rate for <Text style={{ fontWeight: 'bold' }}>Professionalism </Text></Text>
                    </View>
                    <View>
                        <Text style={styles.fludderTipText}>Fludder tip: How did the individual come across from a professional standpoint?</Text>
                    </View>
