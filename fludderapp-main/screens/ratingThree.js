...
export default function RatingThree({ navigation }) {
    ...
    const secondRating = navigation.getParam('currentRating');

    const pressHandler = (thirdRating) => {
        setCurrentRating(thirdRating);
    }
    const pressHandler1 = () => {
        navigation.navigate('RatingTwo', { answer, reviewText, firstRating, });
    }
    const pressHandler2 = () => {
        if (currentRating > 0)
            navigation.navigate('RatingFour', { answer, reviewText, firstRating, secondRating, currentRating });
        else
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ backgroundColor: '#fff' }}>
                <View style={styles.container}>
                    ...
                    <View style={styles.EnergyAndTonequestionBox}>
                        <Text style={{ fontSize: 22 }}>Rate for <Text style={{ fontWeight: 'bold' }}>Energy & Tone</Text></Text>
                    </View>
                    <View>
                        <Text style={styles.fludderTipText}>Fludder tip: How enthusiastic was the individual and was their tone appropriate?</Text>
                    </View>
