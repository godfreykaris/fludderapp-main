...
export default function RatingOne({ navigation }) {
    ...
    const pressHandler2 = () => {
        if (currentRating > 0)
            navigation.navigate('RatingTwo', { answer, reviewText, currentRating });
        else
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView style={{ backgroundColor: '#fff' }}>
                <View style={styles.container}>
                    ...
                    <View style={styles.questionBoxNew}>
                        <Text style={{ fontSize: 22 }}>Rate for <Text style={{ fontWeight: 'bold' }}>Confidence </Text></Text>
                    </View>
                    <View>
                        <Text style={styles.fludderTipText}>Fludder tip: Does the individual believe in themselves?</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 10 }}>
                        ...
                        >
                            <Image source={currentRating >= 1 ? require('../assets/01-Fludder-Reating-Block-Orange.jpg') : require('../assets/01-Fludder-Reating-Block.jpg')} style={{ height: 30, width: 30, margin: 4, marginLeft: 20, resizeMode: 'stretch' }} />
                        </TouchableOpacity>
                        <TouchableOpacity
                            activeOpacity={.5}
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        >
                            <Text style={styles.TextStyleNew}> Back </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={styles.SkipButtonStyle}
                            activeOpacity={.5}
                        ...
                        >
                            <Text style={styles.TextStyleNew}> Next </Text>
                        </TouchableOpacity>
                    </View>
                </View>
